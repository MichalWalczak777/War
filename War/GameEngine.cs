...
namespace War
{
    class GameEngine
    {
        ...
        void Clash(Card cardOfPlayerOne, Card cardOfPlayerTwo)
        {
        ...
        void SendCardsToPlayersDeck(Player player, List <Card> cards)
        {
        ...
        {
            PreparationModule preparationModule = new PreparationModule();
